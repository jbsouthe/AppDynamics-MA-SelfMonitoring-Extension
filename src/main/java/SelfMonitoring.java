...
public class SelfMonitoring extends AManagedMonitor {
    ...
    private String metricPrefix = "Custom Metrics|MA Heap|"; //the MA IGNORES custom metrics unless they start with 'Custom Metrics|' so make it happen programmatically
